...
public class Ex9Test {
    ...
    @Test
    public void testOtherApproach() {
        Comparator<Name> lastThenFirstComparator = Ex9OtherApproach.lexographicComparator("lastname", "firstname");
        Comparator<Name> firstThenLastComparator = Ex9OtherApproach.lexographicComparator("firstname", "lastname");
